<%@ Page Title="" Language="C#" MasterPageFile="~/MasterParent.master" AutoEventWireup="true" CodeFile="login.aspx.cs" Inherits="login" %>
        ...
        <div class="col_1_2">
            <div class="pad_20">
                <div class="log_container">
                    ...
                    <span id="title">Welcome User!!</span>
                    <span class="space10"></span>
                    <span id="title2">Please Enter Your Credentials Below</span>
                    <span class="space20"></span>
                    <div class="pad_30">
                        <asp:TextBox ID="txtPhone" CssClass="textBox" runat="server" placeholder="Enter Username"></asp:TextBox>
                        <span class="space30"></span>
                        ...
                        <span class="space10"></span>
                        <div class="doctor-login">Are you a Doctor? <a href="loginDoctor.aspx">Login here</a></div>
                        <span class="space20"></span>
                    </div>
